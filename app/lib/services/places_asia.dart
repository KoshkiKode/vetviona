...
const List<Place> placesAsia = [
  ...
  // ── Additional China ──────────────────────────────────────────────────────
  Place(continent:'Asia', name:'Chengdu', modernCountry:'China', iso3:'CHN', state:'Sichuan Province',
    historicalContext:'Sichuan capital; Panda research base; Tang-era Du Fu lived here; spicy cuisine.',
    nativeTribes:'Yi, Tibetan minorities', romanizedNative:'成都'),
  Place(continent:'Asia', name:'Wuhan', modernCountry:'China', iso3:'CHN', state:'Hubei Province',
    historicalContext:'Three-towns metropolis; 1911 Revolution began here; major Yangtze River port.',
    nativeTribes:'Han Chinese', romanizedNative:'武汉'),
  Place(continent:'Asia', name:'Tianjin', modernCountry:'China', iso3:'CHN', state:'Tianjin Municipality',
    historicalContext:'Major northern port; foreign concession areas; salt trade hub.',
    colonizer:'British Empire, French Empire, others (concessions)', romanizedNative:'天津'),
  Place(continent:'Asia', name:'Hangzhou', modernCountry:'China', iso3:'CHN', state:'Zhejiang Province',
    historicalContext:'Southern Song Dynasty capital; Marco Polo called it greatest city in the world.',
    nativeTribes:'Han Chinese', romanizedNative:'杭州'),
  Place(continent:'Asia', name:'Shenyang', modernCountry:'China', iso3:'CHN', state:'Liaoning Province',
    historicalContext:'Manchurian capital Mukden; Manchu ancestral home; Japanese-occupied Manchukuo.',
    colonizer:'Japanese Empire (Manchukuo)', nativeTribes:'Manchu, Han Chinese', romanizedNative:'沈阳'),
  Place(continent:'Asia', name:'Harbin', modernCountry:'China', iso3:'CHN', state:'Heilongjiang Province',
    historicalContext:'Russian-built railway town; large Russian and Jewish community; ice festival.',
    colonizer:'Russian Empire', romanizedNative:'哈尔滨'),
  Place(continent:'Asia', name:'Kunming', modernCountry:'China', iso3:'CHN', state:'Yunnan Province',
    historicalContext:'Spring City; WWII supply route Burma Road end; diverse minority peoples.',
    nativeTribes:'Yi, Bai, Dai, numerous others', romanizedNative:'昆明'),
  Place(continent:'Asia', name:'Suzhou', modernCountry:'China', iso3:'CHN', state:'Jiangsu Province',
    historicalContext:'Venice of the East; classical gardens UNESCO; silk production centre.',
    nativeTribes:'Han Chinese', romanizedNative:'苏州'),

  // ── Additional India ──────────────────────────────────────────────────────
  Place(continent:'Asia', name:'Pune', modernCountry:'India', iso3:'IND', state:'Maharashtra',
    historicalContext:'Maratha Empire capital; Peshwa centre; British Deccan cantonment; tech hub.',
    nativeTribes:'Marathi', romanizedNative:'Poona'),
  Place(continent:'Asia', name:'Jaipur', modernCountry:'India', iso3:'IND', state:'Rajasthan',
    historicalContext:'Pink City; Rajput Maharajas of Kachwaha; planned 1727; UNESCO World Heritage.',
    nativeTribes:'Rajasthani', romanizedNative:'Jaipur'),
  Place(continent:'Asia', name:'Lucknow', modernCountry:'India', iso3:'IND', state:'Uttar Pradesh',
    historicalContext:'Capital of the Nawabs of Awadh; Mughal-influenced culture; 1857 Mutiny siege.',
    colonizer:'Mughal Empire, British Empire', nativeTribes:'Hindi-speaking'),
  Place(continent:'Asia', name:'Ahmedabad', modernCountry:'India', iso3:'IND', state:'Gujarat',
    historicalContext:'Gandhi\'s ashram; Mughal sultanate; textile industry; UNESCO walled city.',
    colonizer:'Mughal Empire, British Empire', nativeTribes:'Gujarati'),
  Place(continent:'Asia', name:'Patna', modernCountry:'India', iso3:'IND', state:'Bihar',
    historicalContext:'Ancient Pataliputra; Maurya Empire capital; Ashoka\'s court; Sikh pilgrimage (Harmandir Sahib).',
    colonizer:'British Empire', nativeTribes:'Bihari', romanizedNative:'Pataliputra'),
  Place(continent:'Asia', name:'Surat', modernCountry:'India', iso3:'IND', state:'Gujarat',
    historicalContext:'First East India Company factory in India; Mughal port; diamond cutting centre.',
    colonizer:'Mughal Empire, British Empire', nativeTribes:'Gujarati'),
  Place(continent:'Asia', name:'Madurai', modernCountry:'India', iso3:'IND', state:'Tamil Nadu',
    historicalContext:'Ancient Tamil city; Meenakshi Temple; Pandya Dynasty capital; never fully colonised.',
    colonizer:'British Empire', nativeTribes:'Tamil'),
  Place(continent:'Asia', name:'Amritsar', modernCountry:'India', iso3:'IND', state:'Punjab',
    historicalContext:'Golden Temple (Harmandir Sahib) Sikh holy city; 1919 Jallianwala Bagh massacre.',
    colonizer:'Mughal Empire, British Empire', nativeTribes:'Punjabi, Sikh'),
  Place(continent:'Asia', name:'Visakhapatnam', modernCountry:'India', iso3:'IND', state:'Andhra Pradesh',
    historicalContext:'Major Eastern India port; submarine museum; Telugu culture; steel industry.',
    colonizer:'British Empire', nativeTribes:'Telugu'),
  Place(continent:'Asia', name:'Kanpur', modernCountry:'India', iso3:'IND', state:'Uttar Pradesh',
    historicalContext:'Major industrial city on Ganges; 1857 Mutiny massacre; leather and textile records.',
    colonizer:'British Empire', nativeTribes:'Hindi-speaking'),
  Place(continent:'Asia', name:'Nagpur', modernCountry:'India', iso3:'IND', state:'Maharashtra',
    historicalContext:'Geographic centre of India; Nagpur Agreement signed here; orange groves.',
    colonizer:'British Empire', nativeTribes:'Marathi'),
  Place(continent:'Asia', name:'Bhopal', modernCountry:'India', iso3:'IND', state:'Madhya Pradesh',
    historicalContext:'City of Lakes; Nawab of Bhopal princely state; 1984 Union Carbide disaster.',
    colonizer:'British Empire', nativeTribes:'Hindi-speaking'),
  Place(continent:'Asia', name:'Indore', modernCountry:'India', iso3:'IND', state:'Madhya Pradesh',
    historicalContext:'Holkar Maratha dynasty; major central Indian commercial hub.',
    colonizer:'British Empire', nativeTribes:'Marathi'),
  Place(continent:'Asia', name:'Coimbatore', modernCountry:'India', iso3:'IND', state:'Tamil Nadu',
    historicalContext:'Manchester of South India; textile mills; Nilgiri Hills gateway.',
    colonizer:'British Empire', nativeTribes:'Tamil'),
  Place(continent:'Asia', name:'Kochi', modernCountry:'India', iso3:'IND', state:'Kerala',
    historicalContext:'Queen of the Arabian Sea; Vasco da Gama died here; Jewish synagogue; spice trade.',
    colonizer:'Portuguese Empire, Dutch Republic, British Empire', nativeTribes:'Malayalam', romanizedNative:'Cochin'),
  Place(continent:'Asia', name:'Thiruvananthapuram', modernCountry:'India', iso3:'IND', state:'Kerala',
    historicalContext:'Kerala capital; Travancore princely state; Padmanabhaswamy Temple gold vaults.',
    colonizer:'British Empire', nativeTribes:'Malayalam', romanizedNative:'Trivandrum'),

  // ── Additional Japan ──────────────────────────────────────────────────────
  Place(continent:'Asia', name:'Yokohama', modernCountry:'Japan', iso3:'JPN', state:'Kanagawa Prefecture',
    historicalContext:'First major western-opened port 1859; Chinatown; WWII Allied occupation HQ.',
    nativeTribes:'Ainu (historically)', romanizedNative:'横浜'),
  Place(continent:'Asia', name:'Nagoya', modernCountry:'Japan', iso3:'JPN', state:'Aichi Prefecture',
    historicalContext:'Oda Nobunaga\'s origin; Toyota; major manufacturing and castle city.',
    nativeTribes:'Ainu (historically)', romanizedNative:'名古屋'),
  Place(continent:'Asia', name:'Sapporo', modernCountry:'Japan', iso3:'JPN', state:'Hokkaido Prefecture',
    historicalContext:'Hokkaido capital; Ainu indigenous homeland; Snow Festival; 1972 Winter Olympics.',
    nativeTribes:'Ainu', romanizedNative:'札幌'),
  Place(continent:'Asia', name:'Sendai', modernCountry:'Japan', iso3:'JPN', state:'Miyagi Prefecture',
    historicalContext:'Tohoku\'s largest city; Date Masamune domain; 2011 earthquake and tsunami.',
    nativeTribes:'Emishi (historically)', romanizedNative:'仙台'),
  Place(continent:'Asia', name:'Kamakura', modernCountry:'Japan', iso3:'JPN', state:'Kanagawa Prefecture',
    historicalContext:'Shogunate capital 1185–1333; Great Buddha (Daibutsu); significant Buddhist records.',
    romanizedNative:'鎌倉'),
  Place(continent:'Asia', name:'Fukuoka', modernCountry:'Japan', iso3:'JPN', state:'Fukuoka Prefecture',
    historicalContext:'Gateway to Asia; Mongol invasion landing point; Hakata textile trade.',
    romanizedNative:'福岡'),
  Place(continent:'Asia', name:'Kobe', modernCountry:'Japan', iso3:'JPN', state:'Hyogo Prefecture',
    historicalContext:'Major foreign settlement port; 1995 earthquake; sake production; Chinatown.',
    romanizedNative:'神戸'),

  // ── Additional South Korea ────────────────────────────────────────────────
  Place(continent:'Asia', name:'Busan', modernCountry:'South Korea', iso3:'KOR', state:'Busan Metropolitan City',
    historicalContext:'South Korea\'s second city; major port; Korean War last stand; fish market.',
    colonizer:'Japanese Empire', romanizedNative:'부산'),
  Place(continent:'Asia', name:'Incheon', modernCountry:'South Korea', iso3:'KOR', state:'Incheon Metropolitan City',
    historicalContext:'Gateway port; MacArthur landing 1950; international airport.',
    colonizer:'Japanese Empire', romanizedNative:'인천'),
  Place(continent:'Asia', name:'Daegu', modernCountry:'South Korea', iso3:'KOR', state:'Daegu Metropolitan City',
    historicalContext:'Textile city; Presbyterian mission centre; important Korean War records.',
    colonizer:'Japanese Empire', romanizedNative:'대구'),

  // ── Additional Turkey ─────────────────────────────────────────────────────
  Place(continent:'Asia', name:'Izmir', modernCountry:'Turkey', iso3:'TUR', state:'İzmir Province',
    historicalContext:'Ancient Smyrna; Greek city until 1922 exchange; major Aegean port.',
    colonizer:'Byzantine Empire, Ottoman Empire', nativeTribes:'Greek, Anatolian', romanizedNative:'Σμύρνη / Smyrna'),
  Place(continent:'Asia', name:'Bursa', modernCountry:'Turkey', iso3:'TUR', state:'Bursa Province',
    historicalContext:'First Ottoman capital; silk weaving; Green Mosque; Osman Gazi tomb.',
    colonizer:'Byzantine Empire, Ottoman Empire', nativeTribes:'Bithynians', romanizedNative:'Prusa'),
  Place(continent:'Asia', name:'Konya', modernCountry:'Turkey', iso3:'TUR', state:'Konya Province',
    historicalContext:'Rumi (Mevlana) tomb; Seljuk Sultanate of Rum capital; ancient Iconium.',
    colonizer:'Byzantine Empire, Ottoman Empire', nativeTribes:'Phrygians', romanizedNative:'Iconium'),
  Place(continent:'Asia', name:'Gaziantep', modernCountry:'Turkey', iso3:'TUR', state:'Gaziantep Province',
    historicalContext:'South-eastern Anatolian city; Roman mosaics; baklava capital; Syrian border.',
    colonizer:'Ottoman Empire, French mandate (briefly)', nativeTribes:'Hittites, Arameans'),
  Place(continent:'Asia', name:'Trabzon', modernCountry:'Turkey', iso3:'TUR', state:'Trabzon Province',
    historicalContext:'Black Sea port; Empire of Trebizond 1204–1461; Venetian and Genoese trading post.',
    colonizer:'Byzantine Empire, Ottoman Empire', nativeTribes:'Pontic Greeks, Laz', romanizedNative:'Trapezus'),

  // ── Additional Iran ───────────────────────────────────────────────────────
  Place(continent:'Asia', name:'Tabriz', modernCountry:'Iran', iso3:'IRN', state:'East Azerbaijan Province',
    historicalContext:'Northwestern Iranian city; Ilkhanate capital; Azerbaijani cultural centre; carpet making.',
    colonizer:'Mongol Empire, Russian Empire (briefly)', nativeTribes:'Azerbaijanis, Armenians', romanizedNative:'تبریز'),
  Place(continent:'Asia', name:'Mashhad', modernCountry:'Iran', iso3:'IRN', state:'Razavi Khorasan Province',
    historicalContext:'Holiest city in Iran; Imam Reza shrine; Khorasan region Silk Road junction.',
    colonizer:'Mongol Empire', nativeTribes:'Persian', romanizedNative:'مشهد'),
  // ── Additional Saudi Arabia ───────────────────────────────────────────────
  // ── Additional Pakistan ───────────────────────────────────────────────────
  Place(continent:'Asia', name:'Peshawar', modernCountry:'Pakistan', iso3:'PAK', state:'Khyber Pakhtunkhwa',
    historicalContext:'Khyber Pass gateway; ancient Gandhara; British North-West Frontier Province.',
    colonizer:'British Empire', nativeTribes:'Pashtun', romanizedNative:'پشاور'),
  Place(continent:'Asia', name:'Quetta', modernCountry:'Pakistan', iso3:'PAK', state:'Balochistan',
    historicalContext:'Balochistan capital; British cantonment; earthquake-prone; near Afghan border.',
    colonizer:'British Empire', nativeTribes:'Baloch, Brahui'),
  Place(continent:'Asia', name:'Multan', modernCountry:'Pakistan', iso3:'PAK', state:'Punjab',
    historicalContext:'City of Saints; one of the oldest cities in South Asia; Sufi shrine destination.',
    colonizer:'Arab Caliphate, Mughal Empire, British Empire', nativeTribes:'Saraiki-speaking'),
  Place(continent:'Asia', name:'Faisalabad', modernCountry:'Pakistan', iso3:'PAK', state:'Punjab',
    historicalContext:'Manchester of Pakistan; textile industry; British Lyallpur until 1977.',
    colonizer:'British Empire'),

  // ── Additional Southeast Asia ─────────────────────────────────────────────
  Place(continent:'Asia', name:'Davao', modernCountry:'Philippines', iso3:'PHL', state:'Davao del Sur Province',
    historicalContext:'Mindanao\'s largest city; Japanese agricultural settlement pre-WWII; Duterte\'s city.',
    colonizer:'Spanish Empire, Japanese Empire', nativeTribes:'Bagobo, Mandaya'),
  Place(continent:'Asia', name:'Chiang Mai', modernCountry:'Thailand', iso3:'THA', state:'Chiang Mai Province',
    historicalContext:'Lanna Kingdom capital; northern Thai culture; ancient city walls; Doi Suthep temple.',
    colonizer:'Burmese Empire (periodically)', nativeTribes:'Tai Yuan'),
  Place(continent:'Asia', name:'Pattaya', modernCountry:'Thailand', iso3:'THA', state:'Chonburi Province',
    historicalContext:'Fishing village turned international resort; Vietnam War R&R destination.',
    colonizer:'French Indochina proximity', nativeTribes:'Thai'),
  Place(continent:'Asia', name:'Bandung', modernCountry:'Indonesia', iso3:'IDN', state:'West Java Province',
    historicalContext:'Paris van Java; Dutch colonial resort city; Bandung Conference 1955 of Non-Aligned Nations.',
    colonizer:'Dutch Empire', nativeTribes:'Sundanese'),
  Place(continent:'Asia', name:'Yogyakarta', modernCountry:'Indonesia', iso3:'IDN', state:'Special Region of Yogyakarta',
    historicalContext:'Javanese cultural capital; Borobudur and Prambanan nearby; Indonesian independence HQ.',
    colonizer:'Dutch Empire', nativeTribes:'Javanese'),
  Place(continent:'Asia', name:'Surakarta', modernCountry:'Indonesia', iso3:'IDN', state:'Central Java Province',
    historicalContext:'Also called Solo; Javanese royal courts Kraton Surakarta; batik tradition.',
    colonizer:'Dutch Empire', nativeTribes:'Javanese'),
  Place(continent:'Asia', name:'Johor Bahru', modernCountry:'Malaysia', iso3:'MYS', state:'Johor State',
    historicalContext:'Johor Sultanate capital; Causeway to Singapore; major border city.',
    colonizer:'British Empire', nativeTribes:'Malay'),
  Place(continent:'Asia', name:'Da Nang', modernCountry:'Vietnam', iso3:'VNM', state:'Da Nang City',
    historicalContext:'Central Vietnamese port; US Marine landing 1965; Cham Museum; China Beach.',
    colonizer:'Cham Kingdom, French Empire, US military presence', nativeTribes:'Cham, Kinh', romanizedNative:'Đà Nẵng'),
  Place(continent:'Asia', name:'Hue', modernCountry:'Vietnam', iso3:'VNM', state:'Thừa Thiên-Huế Province',
    historicalContext:'Imperial capital of Vietnam; Nguyen dynasty citadel; Tet Offensive 1968.',
    colonizer:'French Empire', nativeTribes:'Kinh', romanizedNative:'Huế'),
  Place(continent:'Asia', name:'Luang Prabang', modernCountry:'Laos', iso3:'LAO', state:'Luang Prabang Province',
    historicalContext:'Royal capital; UNESCO town; Buddhist temple-city; French colonial architecture.',
    colonizer:'French Empire', nativeTribes:'Lao'),

  // ── Additional Central Asia ───────────────────────────────────────────────
  Place(continent:'Asia', name:'Khiva', modernCountry:'Uzbekistan', iso3:'UZB', state:'Khorezm Region',
    historicalContext:'Ancient Khorezm oasis city; Silk Road stop; Russian Empire conquest 1873.',
    colonizer:'Russian Empire', nativeTribes:'Khorezmians, Uzbek', romanizedNative:'Xiva'),
  Place(continent:'Asia', name:'Shymkent', modernCountry:'Kazakhstan', iso3:'KAZ', state:'Shymkent City',
    historicalContext:'Third largest Kazakh city; crossroads of Silk Road; lead refinery records.',
    colonizer:'Russian Empire', nativeTribes:'Kazakh'),

  // ── Additional Caucasus ───────────────────────────────────────────────────
  Place(continent:'Asia', name:'Gyumri', modernCountry:'Armenia', iso3:'ARM', state:'Shirak Province',
    historicalContext:'Second Armenian city; formerly Alexandropol then Leninakan; 1988 earthquake records.',
    colonizer:'Russian Empire', nativeTribes:'Armenian', romanizedNative:'Ալեքսանդրապոլ'),
  Place(continent:'Asia', name:'Ganja', modernCountry:'Azerbaijan', iso3:'AZE', state:'Ganja City',
    historicalContext:'Second Azerbaijani city; Nizami Ganjavi birthplace; formerly Kirovabad in Soviet era.',
    colonizer:'Russian Empire', nativeTribes:'Azerbaijani', romanizedNative:'Kirovabad'),
  Place(continent:'Asia', name:'Batumi', modernCountry:'Georgia', iso3:'GEO', state:'Adjara',
    historicalContext:'Black Sea resort port; Ottoman then Russian; Adjara autonomous region; oil pipeline terminus.',
    colonizer:'Ottoman Empire, Russian Empire', nativeTribes:'Adjarians, Georgians'),
